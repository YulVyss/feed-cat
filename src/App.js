...
const content = [
  ...
  {
    id: 4, tagline: 'Сказочное заморское яство', title: 'Нямушка', taste: 'с рыбой', description: ['40 порций',
      '2 мышь в подарок', '2 мышь в подарок', '2 мышь в подарок', '2 мышь в подарок'], text: 'Головы щучьи с чесноком да свежайшая сёмгушка.', weight: '2', selected: true, disabled: false,
  },
]
